...
- **Computer Vision & Deep Learning** — face recognition, satellite image enhancement, image colorization
- **Machine Learning Pipelines** — forecasting, model evaluation, preprocessing, visual analysis
- **Full-Stack Development** — React, Node.js, Express.js, MongoDB
- **Problem Solving** — DSA practice in C++ for SDE roles
